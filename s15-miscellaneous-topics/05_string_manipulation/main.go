...
func main() {
	testCase1() // call testCase1() to testCase2()
}
...
func testCase3() {
	...
	fmt.Println(strings.Map(shiftOne, "ABCDabcd I al going"))
...
func testCase5() {
	...
	fmt.Println(strings.Trim("!!!**Como Estas*!**", "!*"))

	fmt.Println(strings.TrimLeft("!!!**Como Estas*!**", "!*"))

	fmt.Println(strings.TrimRight("!!!**Como Estas*!**", "!*"))
